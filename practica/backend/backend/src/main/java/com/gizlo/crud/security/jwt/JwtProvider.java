package com.gizlo.crud.security.jwt;


import com.gizlo.crud.security.request.JwtRequest;
import com.gizlo.crud.security.response.UsuarioResponse;
...
public class JwtProvider {
    ...
    public String generateToken(Authentication authentication){
        UsuarioResponse usuarioPrincipal = (UsuarioResponse) authentication.getPrincipal();
    ...
    public String refreshToken(JwtRequest jwtRequest) throws ParseException {
        JWT jwt = JWTParser.parse(jwtRequest.getToken());
